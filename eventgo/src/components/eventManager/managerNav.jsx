  ...
  return (
    <>
      <div className="flex w-full z-50">
        <aside className="fixed top-0 left-0 w-64 h-full" aria-label="Sidenav">
          <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <ul className="space-y-2">
              <h3 className="text-3xl p-2 select-none font-medium text-transparent bg-clip-text bg-gradient-to-r from-tl_signup to-bl_signup">
                EventGO
              </h3>
              <li>
                <Link
              ...
              <li>
                <Link
                  ...
                  className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group"
                >
                  <FcInvite className="w-6 h-6 ransition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
          ...
          <div className="hidden absolute bottom-0 left-0 justify-start p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
            <Link
              to="/manager/profile"
        ...
        {/* Outlet */}
        <div className="static w-[100vw] ml-[16rem] px-5 pt-4">
          <ManagerAppBar />
          <Outlet />
        </div>
      </div>
