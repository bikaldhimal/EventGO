    ...
    <>
      <div className="container mx-auto h-[50rem] overflow-hidden overflow-y-auto bg-slate-50 p-5">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {/* card */}
          <div className="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out overflow-y-scroll">
            ...
            <div className="">
              <div className="px-7 mb-8">
                ...
                <p className="text-gray-400 mt-2 dark:text-gray-400">Artist</p>
                <p className="mt-2 text-gray-600 dark:text-gray-300 text-justify">
                  I believe that art has the power to transform individuals and
                  communities, and I am committed to using my creativity to make
            ...
            <div className="">
              <div className="px-7 mb-8">
                ...
                <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
                  ...
                  <button className="text-green-900 hover:text-green-700 p-1 sm:p-2  inline-flex items-center ark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
                    <svg
                      className="w-7 h-7 fill-current"
                      role="img"
                      viewBox="0 0 256 256"
