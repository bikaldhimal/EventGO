    ...
    <>
      <div className="flex justify-between items-center gap-3 w-full border-2 rounded-lg px-5 py-2 bg-gray-800 transparent mb-5">
        <div className="flex justify-between items-center gap-3">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1635205383450-e0fee6fe73c4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1365&q=80"
              alt="user profile"
          ...
          <div className="flex flex-col text-white py-2">
            <h4 className="font-normal text-[16px] font-serif leading-5">
              {name} <br />
              <span className="text-xs font-light font-serif">{role}</span>{" "}
              <br />
