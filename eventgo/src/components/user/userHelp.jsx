    ...
    <>
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
        ...
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline hover:text-blue-700 hover:decoration-blue-700">
            <Link to="/user/profile">Manage your profile</Link>
          </h3>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
        ...
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline hover:text-blue-700 hover:decoration-blue-700">
            <Link to="/user/follower">View available artist</Link>
          </h3>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
        ...
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline hover:text-blue-700 hover:decoration-blue-700">
            <Link to="/user/message">Start conversations</Link>
          </h3>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
        ...
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline hover:text-blue-700 hover:decoration-blue-700">
            <Link to="/user/ticket">View purchased tickets</Link>
          </h3>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
